 ...
 * If uiEvent is:
 *
 * FSE_OUTPUT, pData points to a TCHAR array containing the output message.
...
public:
  ...
  // frame has been completely processed. The calling thread
  // will block, but continue to process any windows messages,
  // sans keyboard shortcuts and dialog messages.
  void Terminate(void);
...
protected:
  ...
  static void _FireFatal(PFURRSESSIONTHREAD pfst);
  ...
  static void _AMSCommErrorCallback(CTSTRING &tsMessage, DWORD_PTR dwUserData);
