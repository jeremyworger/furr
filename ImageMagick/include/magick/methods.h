/*
  ImageMagick Magick API Method Prefix.

  nm .libs/libMagick.a | grep ' T ' | \
    awk '{ printf("#define %s  PrependMagickMethod(%s)\n", $3, $3); }' | \
    sort
*/
#ifndef _MAGICK_METHOD_H
#define _MAGICK_METHOD_H
...
#define AnimateImageCommand  PrependMagickMethod(AnimateImageCommand)
#define AnimateImages  PrependMagickMethod(AnimateImages)
#define AnnotateImage  PrependMagickMethod(AnnotateImage)
#define AppendElementToLinkedList  PrependMagickMethod(AppendElementToLinkedList)
...
#define CompareImageCommand  PrependMagickMethod(CompareImageCommand)
#define CompareImages  PrependMagickMethod(CompareImages)
#define CompareStringInfo  PrependMagickMethod(CompareStringInfo)
#define CompositeImageCommand  PrependMagickMethod(CompositeImageCommand)
...
#define ConjureImageCommand  PrependMagickMethod(ConjureImageCommand)
...
#define ConvertImageCommand  PrependMagickMethod(ConvertImageCommand)
...
#define DestroyBlobInfo  PrependMagickMethod(DestroyBlobInfo)
...
#define DisplayImageCommand  PrependMagickMethod(DisplayImageCommand)
...
#define FormatSize  PrependMagickMethod(FormatSize)
...
#define GetElementFromLinkedList  PrependMagickMethod(GetElementFromLinkedList)
#define GetEntryFromHashmap  PrependMagickMethod(GetEntryFromHashmap)
...
#define GetImageInfoAttribute  PrependMagickMethod(GetImageInfoAttribute)
...
#define GetLastElementInLinkedList  PrependMagickMethod(GetLastElementInLinkedList)
...
#define GetLocaleInfo  PrependMagickMethod(GetLocaleInfo)
#define GetLocaleList  PrependMagickMethod(GetLocaleList)
#define GetLocaleMessage  PrependMagickMethod(GetLocaleMessage)
#define GetLocaleMonitorMessage  PrependMagickMethod(GetLocaleMonitorMessage)
...
#define GetNextElementInLinkedList  PrependMagickMethod(GetNextElementInLinkedList)
#define GetNextEntryInHashmap  PrependMagickMethod(GetNextEntryInHashmap)
...
#define GetToken  PrependMagickMethod(GetToken)
...
#define IdentifyImageCommand  PrependMagickMethod(IdentifyImageCommand)
...
#define ImportImageCommand  PrependMagickMethod(ImportImageCommand)
...
#define InsertElementInLinkedList  PrependMagickMethod(InsertElementInLinkedList)
#define InsertElementInSortedLinkedList  PrependMagickMethod(InsertElementInSortedLinkedList)
#define InsertImageInList  PrependMagickMethod(InsertImageInList)
#define InterpolateColor  PrependMagickMethod(InterpolateColor)
#define InvokeDelegate  PrependMagickMethod(InvokeDelegate)
#define InvokePostscriptDelegate  PrependMagickMethod(InvokePostscriptDelegate)
...
#define IsTrue  PrependMagickMethod(IsTrue)
#define JPEGEncodeImage  PrependMagickMethod(JPEGEncodeImage)
...
#define LoadWPG2Flags  PrependMagickMethod(LoadWPG2Flags)
...
#define Modulate  PrependMagickMethod(Modulate)
#define MogrifyImageCommand  PrependMagickMethod(MogrifyImageCommand)
#define MogrifyImageList  PrependMagickMethod(MogrifyImageList)
#define MogrifyImage  PrependMagickMethod(MogrifyImage)
#define MogrifyImages  PrependMagickMethod(MogrifyImages)
#define MontageImageCommand  PrependMagickMethod(MontageImageCommand)
...
#define OpenCache  PrependMagickMethod(OpenCache)
...
#define RegisterCLIPBOARDImage  PrependMagickMethod(RegisterCLIPBOARDImage)
...
#define RegisterEMFImage  PrependMagickMethod(RegisterEMFImage)
...
#define RegisterFPXImage  PrependMagickMethod(RegisterFPXImage)
...
#define UnregisterCLIPBOARDImage  PrependMagickMethod(UnregisterCLIPBOARDImage)
...
#define UnregisterEMFImage  PrependMagickMethod(UnregisterEMFImage)
...
#define UnregisterFPXImage  PrependMagickMethod(UnregisterFPXImage)
...
#define Upsample  PrependMagickMethod(Upsample)
...
#define XMagickMonitor  PrependMagickMethod(XMagickMonitor)
...
#define XMonitorWidget  PrependMagickMethod(XMonitorWidget)
